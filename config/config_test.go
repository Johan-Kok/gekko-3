...
func TestUnmarshalWithDecoderOptions(t *testing.T) {
	...
	opt := DecodeHook(mapping.ComposeDecodeHookFunc(
...
func TestBindPFlags(t *testing.T) {
	v := New() // create independent Config object
...
func TestSub(t *testing.T) {
	...
	assert.Equal(t, (*Config)(nil), subv)
...
func newConfigWithConfigFile(t *testing.T) (*Config, string, func()) {
...
func newConfigWithSymlinkedConfigFile(t *testing.T) (*Config, string, string, func()) {
	watchDir, err := ioutil.TempDir("", "")
	require.Nil(t, err)
...
func TestWatchFile(t *testing.T) {
	...
	t.Run("file content changed", func(t *testing.T) {
		...
		v, configFile, cleanup := newConfigWithConfigFile(t)
		defer cleanup()
	...
	t.Run("link to real file changed (à la Kubernetes)", func(t *testing.T) {
		...
		v, watchDir, _, _ := newConfigWithSymlinkedConfigFile(t)
		// defer cleanup()
		wg := sync.WaitGroup{}
		v.WatchConfig()
		v.OnConfigChange(func(in fsnotify.Event) {
